<template>
  <section>
    ...
    <router-link v-if="!isProduct2" to="/products/p2">Product 2</router-link>
  </section>
</template>
...
export default {
  ...
  setup(props) {
    ...
    const isProduct2 = computed(() => selectedProduct.value.id === 'p2');

    return { title, price, description, isProduct2 };
  },
};
</script>
